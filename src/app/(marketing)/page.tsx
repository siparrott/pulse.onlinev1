...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <header className="relative z-10 border-b border-zinc-900/80 bg-zinc-950/70 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 rounded-none bg-emerald-500 px-4 py-2 text-sm font-semibold text-zinc-950 transition hover:bg-emerald-400"
            >
              Sign in
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-12 gap-8 px-6 pb-10 pt-12 sm:pt-16">
          <div className="col-span-12 md:col-span-6">
            ...
            <p className="mt-5 max-w-xl text-zinc-300/90">
              AxixOS is the system that keeps multi-channel publishing
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href="/login"
                className="group inline-flex items-center justify-center gap-2 rounded-none bg-emerald-500 px-4 py-2 text-sm font-semibold tracking-wide text-zinc-950 transition hover:bg-emerald-400"
              >
                Get started
              ...
              <a
                href="#governance"
                className="group inline-flex items-center justify-center gap-2 rounded-none border border-zinc-700 bg-zinc-900/40 px-4 py-2 text-sm font-semibold tracking-wide text-zinc-100 transition hover:border-zinc-500 hover:bg-zinc-900/70"
              >
      ...
      {/* Governance */}
      <section id="governance" className="relative z-10">
        ...
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="text-xs text-zinc-500">
              AxixOS • Governed publishing system • Dark UI • Sharp-corner system
            </div>
